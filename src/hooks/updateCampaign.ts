...
export function useUpdateCampaign(
  ...
  console.log(user);
  let updateCampaign: ((event: FormEvent<HTMLFormElement>) => void) | undefined;
  let deleteCampaign: ((e: FormEvent<HTMLFormElement>) => void) | undefined;
  let createCampaign: ((e: FormEvent<HTMLFormElement>) => void) | undefined;
