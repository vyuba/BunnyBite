            ...
            <div className="flex  w-full flex-col gap-2 pt-2">
              <label className="flex flex-col gap-1 ">
                ...
                <div className="w-full flex flex-col md:flex-row  gap-1.5 pt-1">
                  ...
                  {/* payment cards  */}
                  <div className="bg-tertiay-background text-[#6b6b6b]  focus:outline-none focus:border-focused-border focus:bg-[white] focus-border-2 focus:ring focus:ring-border focus:ring-opacity-50 rounded-md max-w-[375px] py-2 px-3 grid gap-1.5 w-full text-sm border border-border">
                    <div className="flex items-start justify-between w-full">
                      ...
                      <span className="text-sm bg-background px-1.5 rounded-sm py-0.5 border border-border">
                        Default
                      </span>
                    </div>
                    <button className="text-red-500 w-fit text-sm font-medium capitalize cursor-pointer">
                      delete
                    </button>
                  </div>
                  ...
                  <div className="bg-tertiay-background text-[#6b6b6b]  focus:outline-none focus:border-focused-border focus:bg-[white] focus-border-2 focus:ring focus:ring-border focus:ring-opacity-50 rounded-md max-w-[375px] py-2 px-3 grid gap-1.5 w-full text-sm border border-border">
                    ...
                    <div className="w-full flex items-center gap-3">
                      ...
                      <button className="text-black hover:bg-background px-2 py-1.5 rounded-md dark:text-white w-fit text-sm font-medium capitalize cursor-pointer">
                        set as default
                      </button>
                    </div>
                  </div>
