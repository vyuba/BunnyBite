...
const Page = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full gap-2 pb-15">
      ...
      <div className="w-full h-[calc(100%-120px)] flex gap-2">
        ...
        <div className="w-full h-full relative bg-repeat bg-[url('/whatsappbackground.png')] bg-white/20 overflow-hidden rounded-md border border-[#E3E3E3]">
          ...
          {/* Messaging input section 
          <div className="absolute bottom-0 left-0 w-full h-13 p-2 bg-[var(--background)] border-t border-[#E3E3E3]">
            <input
              className="w-full border border-[#E3E3E3] px-3 h-full text-black/70 outline-0 bg-white rounded-full"
              type="text"
            />
